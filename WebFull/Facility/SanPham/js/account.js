        ...
        for (let i = 0; i < admins.length; i++)
            if (email === admins[i].email) {
                if (password === admins[i].password) {
                    ...
                    document.getElementById('signIn').action = "/WebFull/Facility/SanPham/html/admin/admin.html";
                    this.submit();
    ...
    Object.values(accountuser).map(item => {
            if (email === item.email) {
                if (password === item.password) {
                    ...
                    document.getElementById('signIn').action = "/WebFull/Facility/Index.html";
                    this.submit();
                }
    ...
    if (signin == 1) {
        ...
        <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <a href="/WebFull/Facility/SanPham/html/cart.html" class="dropdown-item">
                        <li>Giỏ Hàng</li>
                    </a>
                    <a href="/WebFull/Facility/SanPham/html/user_order.html" class="dropdown-item">
                    <li>Đơn Hàng</li>
                </a>
